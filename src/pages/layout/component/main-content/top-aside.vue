<template>
    <aside class="aside__top" v-if="$route.meta.isTure">
        <!-- <span
        ...
        <div class="aside__top--left" style="height:50px">
            <img src="../../../../assets/img/langchi.jpg" alt=""  style="height:38px;margin:6px 24px">
        </div>
